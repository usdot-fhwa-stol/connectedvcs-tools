...
public class ASN1DecoderTest {
    ...
    public void ASN1DecoderTest() {
       ...
       // System.out.println("Decoded Message: " + result.decodedMessage);
    ...
    public void ASN1DecoderTestEmpty() {
        DecodedResult decodedMessage = decoder.decode(mockMsg2);
