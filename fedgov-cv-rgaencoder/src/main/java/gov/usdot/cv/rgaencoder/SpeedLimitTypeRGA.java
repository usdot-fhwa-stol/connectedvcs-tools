...
public class SpeedLimitTypeRGA {
    private long speedLimitTypeValue;
     ...
     public long getSpeedLimitTypeValue() {
         return speedLimitTypeValue;
     }

     public void setSpeedLimitTypeValue(long speedLimitTypeValue) {
         this.speedLimitTypeValue = speedLimitTypeValue;
     }

     @Override
     public String toString() {
        return "SpeedLimitTypeRGA [speedLimitTypeValue=" + speedLimitTypeValue + "]";
     }
}
